    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-2xl mx-auto p-3 text-center">
        <h1 className="text-3xl font font-semibold text-center my-7'">
          ```jsx About Isis&apos;s Blog
        </h1>
        <div className="text-md text-gray-500 flex flex-col gap-6'">
          <p>
            Welcome to Isis&apos;s Blog! This blog was created by KOM WAFFO
            DANIEL PRINCE as a personal project to share his thoughts and ideas
            with the world. KOM WAFFO is a passionate developer who loves to
